...
/**
 * @file plugins/generic/customMetadata/tests/run.php
 *
...
define('CUSTOMMETADATA_STANDALONE_TESTS', true);
...
foreach ($files as $file) {
    require_once $file;
    $class = 'APP\plugins\generic\customMetadata\tests\\' . basename($file, '.php');
