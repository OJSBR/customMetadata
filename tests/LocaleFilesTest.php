...
/**
 * @file plugins/generic/customMetadata/tests/LocaleFilesTest.php
 *
...
{
    /** Locale codes shipped by the plugin, as OMP 3.4 names them. */
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.customMetadata\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
