...
/**
 * @file plugins/generic/customMetadata/tests/PluginTest.php
 *
...
class PluginTest extends PKPTestCase
{
    ...
    {
        return [
            \APP\plugins\generic\customMetadata\CustomMetadataPlugin::class,
            \APP\plugins\generic\customMetadata\classes\CustomMetadataSettingsForm::class,
        ];
    }
